...
namespace Saloon4K
{
    public partial class Home : Page
    {
        ...
        [WebMethod]
        public static Deal FaceBookShare(int prefix)
        {
            var dealRep = new DealsRepository();
            var deal = dealRep.GetDealById(Convert.ToInt32(prefix));
            return deal;
        }
        ...
        protected void btnShare_Click(object sender, EventArgs e)
        {
            ...
            var hfName = (HiddenField)btn.Parent.FindControl("hfName");
            var hfDescription = (HiddenField)btn.Parent.FindControl("hfDescription");
