    ...
    public class Saloon4KService : ISaloon4KService
    {
            ...
            try
            {
                ...
                if (o["userId"] != null && o["dealId"] != null)
                {
                    ...
                    if (isFavourite == null)
                    {
                        ...
                        UsersRepository.InsertUserPoints(userId, Utilities.Helper.GetPoints(Common.DealFavourite));
                ...
                if (o["userId"] != null && o["saloonId"] != null && o["bookingDate"] != null && o["bookingTime"] != null)
                {
                    ...
                    if (isBooked == null)
                    {
                        var entity = new UserBookedInterestedSaloon()
                        {
                            ...
                            Points = !string.IsNullOrEmpty(points) ? Convert.ToInt32(points) : 0,
                            Voucher = voucher,
                            Status = DealSalonStatus.Pending
                        };
                        rep.InsertBookedSaloon(entity);
                        UsersRepository.InsertUserPoints(userId, Utilities.Helper.GetPoints(Common.SaloonBooked));
                        if (!string.IsNullOrEmpty(points))
                        {
                            var userVoucer = new UserVoucher();
                            userVoucer.UserId = userId;
                            userVoucer.Voucher = voucher;
                            userVoucer.EntityId = saloonId;
                            userVoucer.EntityType = Common.SALON;
                            userVoucer.GeneratedDate = DateTime.Now.Date;
                            userVoucer.Points = Convert.ToInt32(points);
                            UserVouchersRepository.InsertUserVoucher(userVoucer);
                            UsersRepository.DeleteUserPoints(userId, Convert.ToInt32(points));
                            var content = voucher;
                            _returnJson = JsonConvert.SerializeObject(content);
                        }
                        else
                    ...
                    {
                        _returnJson = "Code:AlreadyBooked";
                    }
                }
                else
                {
            ...
            try
            {
                ...
                if (o["userId"] != null && o["saloonId"] != null)
                {
                    ...
                    if (isInterested == null)
                    {
                        ...
                        UsersRepository.InsertUserPoints(userId, Utilities.Helper.GetPoints(Common.SaloonInterested));
        ...
        public Message MakeDealBooking(Stream json)
        {
            try
            {
                ...
                reader.Dispose();
                var o = JObject.Parse(postData);
                if (o["userId"] != null && o["dealId"] != null && o["salonId"] != null)
                {
                    var userId = (int)o["userId"];
                    var dealId = (int)o["dealId"];
                    ...
                    if (isBooked == null)
                    {
                        ...
                        UsersRepository.InsertUserPoints(userId, Utilities.Helper.GetPoints(Common.DealBooked));
                        if (!string.IsNullOrEmpty(points))
                        {
                            var userVoucer = new UserVoucher();
                            userVoucer.UserId = userId;
                            userVoucer.Voucher = voucher;
                            userVoucer.EntityId = dealId;
                ...
                if (o["userId"] != null && o["entityId"] != null && o["type"] != null)
                {
                    ...
                    if (type == "Salon")
                    {
                        ...
                        if (isBooked != null)
                        {
                            ...
                            UsersRepository.DeleteUserPoints(userId, Utilities.Helper.GetPoints(Common.SaloonBooked));
                            var content = Utilities.Helper.GetPoints(Common.SaloonBooked);
                            _returnJson = JsonConvert.SerializeObject(content);
                        }
                        else
                    ...
                    else if (type == "Deal")
                    {
                        ...
                        if (isBooked != null)
                        {
                            ...
                            UsersRepository.DeleteUserPoints(userId, Utilities.Helper.GetPoints(Common.DealBooked));
                            var content = Utilities.Helper.GetPoints(Common.DealBooked);
                            _returnJson = JsonConvert.SerializeObject(content);
                        }
                        else
            ...
            try
            {
                ...
                if (o["userId"] != null && o["dealId"] != null)
                {
                    ...
                    if (isBooked != null)
                    {
                        ...
                        UsersRepository.DeleteUserPoints(userId, Utilities.Helper.GetPoints(Common.DealFavourite));
                        var content = Utilities.Helper.GetPoints(Common.DealFavourite);
                        _returnJson = JsonConvert.SerializeObject(content);
                    }
                    else
            ...
            try
            {
                ...
                if (o["userId"] != null && o["salonId"] != null)
                {
                    ...
                    if (isBooked != null)
                    {
                        ...
                        UsersRepository.DeleteUserPoints(userId, Utilities.Helper.GetPoints(Common.SaloonInterested));
                        var content = Utilities.Helper.GetPoints(Common.SaloonInterested);
                        _returnJson = JsonConvert.SerializeObject(content);
                    }
                    else
        ...
        public Message GetUserById(int userId)
        {
            try
            {
                var content = UsersRepository.GetUserById(userId);
                if (!string.IsNullOrEmpty(content.ToString()))
                {
                    var returnJson = JsonConvert.SerializeObject(content);
                    return WebOperationContext.Current.CreateTextResponse(returnJson, "application/json; charset=utf-8", Encoding.UTF8);
        ...
        public Message GetUserVouchersByUserId(int userId)
        {
            try
            {
                var content = UserVouchersRepository.GetAllUserVouchersByUserId(userId);
                if (content != null && content.Count > 0)
                {
                    var returnJson = JsonConvert.SerializeObject(content);
                    return WebOperationContext.Current.CreateTextResponse(returnJson, "application/json; charset=utf-8", Encoding.UTF8);
        ...
        public Message DeleteUserVoucher(Stream json)
        {
            try
            {
                var reader = new StreamReader(json);
                ...
                reader.Dispose();
                var o = JObject.Parse(postData);
                if (o["userVoucherId"] != null)
                {
                    var userVoucherId = (int)o["userVoucherId"];
                    UserVouchersRepository.DeleteUserVoucher(userVoucherId);
                    var content = "VoucherDeleted";
                    _returnJson = JsonConvert.SerializeObject(content);
                }
                else
                {
        ...
        public Message GetMobileAdds(string country, string addFor, bool isPublic)
        {
            try
            {
                var content = MobileAddsManagementRepository.GetMobileAdd(country, addFor, isPublic);
                if (content != null)
                {
                    var returnJson = JsonConvert.SerializeObject(content);
                    return WebOperationContext.Current.CreateTextResponse(returnJson, "application/json; charset=utf-8", Encoding.UTF8);
