<%@ Page Title="Sarah Beauty | Home" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Saloon4K.Home" %>
                        ...
                        <asp:Repeater runat="server" ID="rptDealsofthday" OnItemDataBound="rptDealsofthday_ItemDataBound"
                            ...
                            <ItemTemplate>
                                <div class="row1">
                                    ...
                                    <div class="sharebar">
                                        <div class="fblike">
                                            <div class='fb-like' data-href='http://localhost:64196/Home.aspx?querystring=<%#Eval("DealId") %>&'
