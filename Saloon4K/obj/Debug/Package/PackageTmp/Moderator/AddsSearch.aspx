...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function Alert() {
            ...
            alert("You can't active it start date should be after the today date");
        }
    </script>
</asp:Content>
                                    ...
                                    <table class="table table-bordered table-striped dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 5%; text-align: center;" colspan="2" runat="server">
                                                    Action(s)
                                                </th>
                                            </tr>
                                        </thead>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="aligncenter">
                                                            <asp:ImageButton Visible='<%#TablePermission=="E" %>' runat="server" ID="btnActivate"
                                                                CommandArgument='<%# Eval("AddsManagementId") %>' CommandName="Activate" ToolTip="Change status of this add"
                                                                ImageUrl="img/edit.png" CssClass="width45" OnClientClick="return confirm('Are you sure you want to activate this add?')" />
                                                        </td>
                                                        <td class="aligncenter">
                                                            <asp:ImageButton Visible='<%#TablePermission=="E" %>' runat="server" ID="btnDelete"
                                                                CommandArgument='<%# Eval("AddsManagementId") %>' CommandName="Delete" ToolTip="Delete"
                                                                ImageUrl="img/delete.png" CssClass="width45" OnClientClick="return confirm('Are you sure you want to delete this add?')" />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
