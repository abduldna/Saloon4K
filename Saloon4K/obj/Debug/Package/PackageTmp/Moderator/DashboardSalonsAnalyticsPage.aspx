<%@ Page Title="Salons Analytics" Language="C#" MasterPageFile="~/Moderator/Moderator.Master"
    AutoEventWireup="true" CodeBehind="DashboardSalonsAnalyticsPage.aspx.cs" Inherits="Saloon4K.Moderator.DashboardSalonsAnalyticsPage" %>
    ...
    <div class="row">
        <div class="block">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="~/Moderator/DashboardSalonsAnalyticsPage.aspx" runat="server">
                    Salons Analytics</a></li>
                ...
                <div class="col-md-12">
                    <div class="block marginTop25">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab2" data-toggle="tab">Most Favourite and Interested Salons Progress</a></li>
                        </ul>
                        <div class="content tab-content">
                                    ...
                                    <asp:UpdatePanel ID="upOverallProgress" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <div class="chartArea" id="divChart" runat="server">
                                                <asp:Chart ID="ChartSalonHistory" runat="server" Width="1100px" Height="350px" BackColor="Transparent">
                                                    <Series>
                                                        <asp:Series Name="History" ChartType="Line" BorderWidth="2" Color="#59AD2F" MarkerColor="White"
                                        ...
                                        <ContentTemplate>
                                            <div class="chartControls">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RadioButton runat="server" ID="rdbMostInterested" Text="Most Interested" GroupName="MostUsed" />
