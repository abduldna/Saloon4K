...
(function (t, e) {
    ...
    function X() {
        ...
        function fe(n, r, a) {
            ...
            function y(t, n) {
                n.click(function (r) {
                    //Code for event details
                    jQuery("#popEvent1").bPopup();
                    jQuery("#lblName").html("");
                    jQuery("#lblDescription").html("");
                    jQuery("#lblAddedDate").html("");

                    jQuery("#lblName").html(t.title);
                    jQuery("#lblDescription").html(t.description);
                    jQuery("#lblAddedDate").html(t.start);
                    if (t.type == "FeaturedDeals") {
                        jQuery("#lnkDelete").attr("href", "http://localhost:64196/Moderator/SearchDeals.aspx");
                        jQuery("#lnkEdit").attr("href", "http://localhost:64196/Moderator/SearchDeals.aspx");
                    }
                    else if (t.type == "Deals") {
                        jQuery("#lnkDelete").attr("href", "http://localhost:64196/Moderator/SearchDeals.aspx");
                        jQuery("#lnkEdit").attr("href", "http://localhost:64196/Moderator/SearchDeals.aspx");
                    }
                    else if (t.type == "Salons") {
                        jQuery("#lnkDelete").attr("href", "http://localhost:64196/Moderator/SearchSalons.aspx");
                        jQuery("#lnkEdit").attr("href", "http://localhost:64196/Moderator/SearchSalons.aspx");
                    }
                    else if (t.type == "Users") {
                        jQuery("#lnkDelete").attr("href", "http://localhost:64196/Moderator/UserManagement.aspx");
                        jQuery("#lnkEdit").attr("href", "http://localhost:64196/Moderator/DealsManagement.aspx");
                    }
                    //alert(t.id);                    
