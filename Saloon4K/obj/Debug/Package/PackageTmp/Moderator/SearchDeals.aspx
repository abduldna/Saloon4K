            ...
            <div class="col-md-12">
                <div class="block">
                    <a class="btn btn-default btn-block btn-clean btnAddNew" href="~/Moderator/AddEditDeals.aspx"
                        visible='<%#TablePermission=="E" %>' runat="server">ADD DEAL</a>
                    <div class="header">
                        <h2>
                            Deals Management</h2>
                    </div>
                                            ...
                                            <asp:Repeater runat="server" ID="rptDeals" OnItemCommand="rptDeals_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:ImageButton runat="server" ToolTip="Edit" ID="btnEdit" CommandArgument='<%# Eval("DealId") %>'
                                                        ...
                                                        <td class="aligncenter">
                                                            <asp:ImageButton Visible='<%#TablePermission=="E" %>' runat="server" ID="btnDelete"
                                                                CommandArgument='<%# Eval("DealId") %>' CommandName="Delete" ToolTip="Delete"
                                                                ImageUrl="img/delete.png" CssClass="width45" OnClientClick="return confirm('Are you sure you want to delete this deal?')" />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
