<%@ Page Title="Deal Bookings" Language="C#" MasterPageFile="~/Moderator/Moderator.Master"
    AutoEventWireup="true" CodeBehind="DealBookings.aspx.cs" Inherits="Saloon4K.Moderator.DealBookings" %>
                                        ...
                                        <tbody>
                                            <asp:Repeater runat="server" ID="rptDeals" OnItemCommand="rptDeals_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <%# Saloon4kBLL.Utilities.Helper.GetDealName(Convert.ToInt32(Eval("DealId")))%>
                                                        </td>
                                                        <td>
                                                            <%# Saloon4kBLL.Utilities.Helper.GetSalonName(Convert.ToInt32(Eval("SalonId")))%>
                                                        </td>
                                                        ...
                                                        <td class="aligncenter">
                                                            <asp:ImageButton runat="server" ID="btnDelete" CommandArgument='<%# Eval("DealId") %>'
                                                                ...
                                                                OnClientClick="return confirm('Are you sure you want to confirm this deal?')" />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
