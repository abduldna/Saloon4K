...
namespace Saloon4K
{
    ...
    public interface ISaloon4KService
    {
        ...
        //GetAllDealsOfTheDay?countryName=UAE
        [OperationContract]
        ...
        //GetAllFeaturedDeals?countryName=UAE
        [OperationContract]
        ...
        //GetAllSalonsInDirectory?directoryId=1&countryName=UAE
        [OperationContract]
        ...
        //{"firstName":"Vipin","lastName":"Kumar","userName":"vipin@bravado.ae","password":"123456","latitude":"29.3684066","longitude":"47.974328900000046","address":"Dubai","city":"Dubai","state":"NULL","country":"UAE","phone":"0559193366","facebook":"www.facebook.com/test.user","about":"this is about me text","deviceId":"50c635c406a6f9305c6fb46a5f078806bfe4ba39076afdc9367b11a9fc66771e"}
        [OperationContract]
        [WebInvoke(Method = "POST", ResponseFormat = WebMessageFormat.Json, UriTemplate = "Register")]
        Message Register(Stream json);

        //{"facebookId":"890164654333623","firstName":"Vipin","lastName":"Kumar","userName":"vipin@bravado.ae","country":"UAE","deviceId":"50c635c406a6f9305c6fb46a5f078806bfe4ba39076afdc9367b11a9fc66771e"}
        [OperationContract]
        ...
        //{"userId":2,"firstName":"Vipin","lastName":"Kumar","password":"123456","address":"Dubai","country":"UAE","phone":"0559193366","facebook":"www.facebook.com/test.user","about":"this is about me text"}
        [OperationContract]
        ...
        //{"userId":1,"saloonId":1,"bookingDate":"3-30-2014","bookingTime":"12:30 PM"}
        [OperationContract]
