...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="content">
        ...
        <div id="DivPopUp" class="DivPopUp" style="height: 835px;">
            <div class="closebtn">
            ...
            <asp:UpdatePanel runat="server" ID="upSaloonDetails" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="popUp" style="height: 810px;">
                        <div class="ribbon">
                            Salon Details
                        </div>
                            ...
                            <div class="divPhone" id="divPhone" runat="server" clientidmode="Static" style="display: none;">
                                <fieldset style="height: 142px;">
                                    ...
                                    <div class="divBookDetails">
                                        <div class="floatLeft">
                                            Phone:<asp:Label runat="server" ID="lblPhone" Style="font-weight: bold;" CssClass="marginLeft10"></asp:Label>
                                        </div>
                                        <div class="floatLeft clear">
                                            <asp:CheckBox runat="server" ID="cbAnswered" CssClass="floatLeft mtop10" /><span
                                                class="floatLeft" style="margin-top: 4px;">Was you call answered?</span>
                                            <asp:Button runat="server" ID="btnAnswered" Text="SUBMIT" CssClass="readmore btn btnBookNow"
                                                OnClick="btnAnswered_Click" Style="margin: 2px 0 0 52px;" />
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
