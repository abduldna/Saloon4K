<%@ Page Title="Users Analytics" Language="C#" MasterPageFile="~/Moderator/Moderator.Master"
    AutoEventWireup="true" CodeBehind="DashboardUsersAnalytics.aspx.cs" Inherits="Saloon4K.Moderator.DashboardUsersAnalytics" %>
    ...
    <div class="row">
        <div class="block">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="~/Moderator/DashboardUsersAnalytics.aspx" runat="server">
                    Users Analytics</a></li>
                            ...
                            <asp:UpdatePanel ID="upMonths" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="chartArea" id="divChart" runat="server">
                                        <asp:Chart ID="ChartClientHistory" runat="server" Width="1150px" Height="500px" BackColor="Transparent">
                                            <Series>
