<%@ Page Title="Salon 4K | Deals Booklist" Language="C#" MasterPageFile="~/UserAccount/Account.master"
            ...
            <asp:Repeater runat="server" ID="rptBookedDeals" OnItemDataBound="rptBookedDeals_ItemDataBound"
                ...
                <ItemTemplate>
                    <li>
                        ...
                        <div class="book">
                            <asp:Button runat="server" ID="lnkBookDelete" CommandName="Delete" CommandArgument='<%# Eval("UserFavouriteBookedDealId") %>'
