                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="aligncenter">
                                                            <asp:ImageButton runat="server" ID="btnDelete" CommandArgument='<%# Eval("UserId") %>'
                                                                CommandName="Delete" ImageUrl="img/delete.png" CssClass="width45" OnClientClick="return confirm('Are you sure you want to delete this user?')" />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
